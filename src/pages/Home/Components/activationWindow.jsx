...
function ActivationWindow() {
  ...
  return (
    <div className="h-39 w-96  flex flex-col gap-4">
      ...
      <input
        ...
        className="ml-8 font-poppins text-bold hover:rounded hover:outline-gray-200 hover:outline focus:outline focus:rounded focus:outline-violet-400 h-10 w-80 "
      ></input>
      <div className="flex flex-row items-center">
        ...
        <input
          type="text"
          className="font-poppins text-bold ml-4 hover:rounded hover:outline-gray-200 hover:outline focus:outline focus:rounded focus:outline-violet-400 h-10 w-80 "
        ></input>
      </div>
      ...
      <div className="flex flex-row items-center">
        ...
        <input
          type="text"
          className=" font-poppins ml-4 text-bold hover:rounded hover:outline-gray-200 hover:outline focus:outline focus:rounded focus:outline-violet-400 h-10 w-80 "
        ></input>
      </div>
